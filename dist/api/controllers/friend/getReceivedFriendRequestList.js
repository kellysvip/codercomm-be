...
exports.getReceivedFriendRequestList = void 0;
const ultis_1 = require("../../../helpers/ultis");
const Friend_1 = require("../../../models/Friend");
const User_1 = require("../../../models/User");
exports.getReceivedFriendRequestList = (0, ultis_1.catchAsync)(async (req, res, next) => {
    ...
    //from: 111 to 222
    //from 789 to 123
    let requestList = await Friend_1.Friend.find({
        to: currentUserId,
        status: "pending",
    });
    // from: 123 to 456
    ...
    // })
    //Response
    (0, ultis_1.sendResponse)(res, 200, true, { users, totalPage, count }, null, "Get Single User Success");
});
